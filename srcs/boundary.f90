...
!
! DESCRIPTION:
!> Module to hold routines for calculating single particle energies. Written by
!> A. Pastore, some variables and use statements modified by M. Shelley for
!> integration into etf code.
module rspace
...
contains
  ...
  subroutine boundary(h,Lmax,Ecut, &
    ...
    use parameters ,only : dhmen,d2hmen,hb2m,vpot,vso,Nmaxstate,verbose,emax0_mod
